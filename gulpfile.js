...
const cleanTask = function () {
    return del(["dist/**", "package.nls.*.json", "ze-extender-new-view*.vsix"]);
};

const generateI18nTask = function () {
    return gulp.src(["package.nls.json"], {allowEmpty:true}).pipe(nls.createAdditionalLanguageFiles(languages, "i18n")).pipe(gulp.dest("."));
};
...
const generateLocalizationBundle = () => {
    ...
    return tsProject
        ...
        .pipe(nls.bundleMetaDataFiles("ze-extender-new-view", outDest))
