...
import { Gui, IZoweTree, IZoweTreeNode, NodeInteraction, PersistenceSchemaEnum } from '@zowe/zowe-explorer-api';
...
export class NewTree implements IZoweTree<NewViewTreeNode> {
    ...
    public constructor(context: vscode.ExtensionContext) {
        this.treeView = Gui.createTreeView("zowe-explorer-extender-newview", {
